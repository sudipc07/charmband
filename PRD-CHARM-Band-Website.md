...
**Domain.** charm.band (canonical). charm-band.com (redirect).
...
- Loses pitches to Tier 1 on perceived credibility and dashboards, not on price or service
- Pain points: ghost workers, supervisor fraud, client SLA disputes, wage cost pressure, 70-80% of revenue going to labour
- **What lands in copy:** "compete with Tier 1 on transparency," "real-time evidence for your clients," "stop paying for work that didn't happen," "white-label dashboards for your contracts," "edge against ISS without their overhead"
- **What kills the pitch:** heavy tech jargon, surveillance language, anything that sounds like it requires their IT team's permission to deploy
...
- Reads "Why us" and trust signals sections
- Cares about: market size, differentiation, team capability, traction signals
- **What lands:** clean writing, sober market positioning, demonstrated domain expertise

---

## 3. Brand voice and word lists
...
- "Surveillance"
- "Monitoring" (in the worker context — fine in "infection-control monitoring")
- "Tracking" (in the worker context)
- "Watch your workers"
- "Big Brother"
- "Discipline"
- "Enforcement"
...
**Wrong (too startup):**
> *"We're revolutionising the way facilities management works! 🚀 Say goodbye to manual check-ins forever."*

**Wrong (too surveillance):**
...
## 4. Page structure with draft copy
...
**Section headline:** *Why existing solutions don't work in the field.*
...
**Section headline:** *Designed for the realities of facilities management.*

Three cards:

**Card 1 — FM contractors**
> Real evidence for SLA reports. Defensible billing. A credibility edge against Tier 1 brands in client pitches.
...
**Section headline:** *From shift start to verifiable record, in three steps.*
...
**Section headline:** *Built by people who have spent decades in each layer.*
...
**Mood references** (for inspiration only — not to be copied):
- Stripe (clean, confident, restrained)
- Linear (sober, considered, designer-grade)
- Twilio (technical credibility without being cold)

**Palette suggestion (starting point, not final):** Deep ink blue or deep teal as the primary, warm off-white background, charcoal text, single accent (warm orange or muted gold). Avoid bright tech-startup gradients. Final palette to be set by whoever does the visual pass.

**Typography:** A serious sans-serif for headlines (Inter, Söhne, or similar). System-sans for body. Keep type generous and confident, not cramped.

**Imagery direction:** Avoid stock photos of fake happy office workers at all costs. Use one of:
- Honest photographs of real cleaning and maintenance work in context
- Clean line illustrations
- Abstract sensor-data visualisations

If unsure, default to abstract sensor-data visualisations — they're on-brand and don't require photography sourcing.

**Logo:** Wordmark only for v1. Lowercase "charm" with a small superscript ™, "Band" set beneath in lighter weight. Proper logo design comes later.
...
- Logged-in areas or any product functionality
- Pricing page (pricing is conversational at this stage; putting numbers up too early damages negotiation)
- Case studies (none to share yet; fabricating them would destroy credibility)
- Testimonial wall (same reason)
- Team page with named individuals (the team is the moat — surface it institutionally, name people in person, not on the site yet)
